        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="mission.php">Mission Content</a>
                    ...
                    <div class="row">
                        <div class="col-xl-7">
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <h6 class="p-2 font-weight-bold text-black mb-2">Mission Content Management</h6>
                                    <form id="missionForm">
