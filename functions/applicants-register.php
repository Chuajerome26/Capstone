...
if(isset($_POST['submit'])){
    ...
    $scholarData = array(
        ...
        'collegeChoice' => isset($_POST["collegeSchool"]) ? $_POST["collegeSchool"]:[] ?? [],
        'collegeCourse' => isset($_POST["collegeCourse"]) ? $_POST["collegeCourse"]:[] ?? [],

        'entranceExam' => $entranceExam ?? [],
        'ifYes' => $ifYes ?? [],
        'ifNo' => $ifNo ?? [],
        'rowCount' => isset($_POST['rowCount']) ? $_POST['rowCount']:''
    );
