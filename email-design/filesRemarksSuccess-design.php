<?php
function fileRemarkSuccess($last_name, $date, $convertedTime, $convertedTime1){
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                <tbody>
                                  ...
                                  <tr>
                                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                      <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">I trust this message finds you well. We wanted to inform you that the evaluation of your scholarship application has been successfully completed.</div>
                                    </td>
                                  </tr>
                                  <tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">
                                    <ul>
                                    <li><strong>NOTE:</strong> Date and Time for Initial Interview</li>
                                  ...
                                  <tr>
                                    <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:25px;word-break:break-word;">
                                      <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">Our committee thoroughly reviewed your academic achievements, extracurricular activities, and personal statements. We appreciate the time and effort you invested in your application.</div>
                                    </td>
                                  </tr>
                                  <tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:30px;word-break:break-word;">
                                    <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">Thank you for your interest in the John Poul B. Galen. We wish you the best of luck in the final stages of the selection process.</div>
                                  </td>
                                </tr>
                                  <tr>
                                    <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:30px;word-break:break-word;">
