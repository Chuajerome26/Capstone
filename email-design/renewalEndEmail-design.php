<?php
function renewalEndEmail($dateFormat1){
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                <tbody>
                                  ...
                                  <tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">We hope this message finds you well. As we approach the end of the scholarship renewal period, we want to remind you to submit your Registration Form to ensure a smooth renewal process.</div>
                                  </td>
                                </tr>
                                <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">The deadline for renewal submissions is '.$dateFormat1.'. Please take a moment to review your renewal requirements and provide any necessary documentation. Failure to complete the renewal process by the deadline may result in the discontinuation of your scholarship.</div>
                                </td>
                              </tr>
                              <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">If you have any questions or concerns, please don\'t hesitate to contact our scholarship office at Consuelo "CHITO" Madrigal Foundation Inc.</div>
                              </td>
                            </tr>
                                <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:30px;word-break:break-word;">
                                  <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">Thank you for your attention to this matter, and we appreciate your continued commitment to your academic pursuits.</div>
                                </td>
                              </tr>
                                  <tr>
                                    <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:30px;word-break:break-word;">
