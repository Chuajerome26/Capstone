<?php
function renewalEvaluationEmail($file1_remarks, $file2_remarks, $getStatus1) {
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                <tbody>
                                  ...
                                  <tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">We have reviewed the documents submitted for your scholarship renewal, and the following require your attention:</div>
                                  </td>
                                </tr>';
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">
                                                <strong>File:</strong> Registration Form<br>
                                                <strong>Remarks:</strong> '.$file1_remarks.'
                                            </div>
                                        </td>
                                    </tr>';
                                }
                                ...
                                if ($getStatus1[0]['file2_status'] == 0) {
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">
                                                <strong>File:</strong> Grade Slip<br>
                                                <strong>Remarks:</strong> '.$file2_remarks.'
                                            </div>
                                        </td>
                                    </tr>';
                                }
                              ...
                              <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">Please update the necessary documents at your earliest convenience to proceed with your scholarship renewal. Ensure that all information is correct and complete before resubmitting.</div>
                              </td>
                            </tr>
                                <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:30px;word-break:break-word;">
                                  <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">Thank you for your prompt attention to this matter.</div>
                                </td>
                              </tr>
                                  <tr>
                                    <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:30px;word-break:break-word;">
