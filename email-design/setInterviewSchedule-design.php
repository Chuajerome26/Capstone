<?php
function SetIntSched($info, $date, $time_start, $time_end, $venue, $contactEmail, $contactPhone){
                                ...
                                <tbody>
                                  <tr>
                                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                      <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">Dear '. $info[0]['f_name'] .' '. $info[0]['l_name'].',</div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  ...
                                  <tr>
                                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                      <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">I hope this message finds you well. We are excited to inform you about the schedule for your upcoming interview for the Scholarship Program.</div>
                                    </td>
                                  </tr>
                                  <tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <li><strong>Interview Time Start:</strong> '.$time_start.'</li>
                                    <li><strong>Interview Time End:</strong> '.$time_end.'</li>
                                  ...
                                  <tr>
                                    <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:25px;word-break:break-word;">
                                      <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">Please make sure to arrive at least 15 minutes before the scheduled interview time. If you have any questions or require any additional information, please do not hesitate to contact us at '.$contactEmail.' or '.$contactPhone.'.</div>
                                    </td>
                                  </tr>
                                  <tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:30px;word-break:break-word;">
                                    <div style="font-family:open Sans, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">We look forward to meeting you and discussing your application further. Best of luck with your interview!</div>
                                  </td>
                                </tr>
                                  <tr>
                                    <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:30px;word-break:break-word;">
                                  ...
                                  <tr>
                                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                      ...
                                      Consuelo "CHITO" Madrigal Foundation, Inc.<br>
                                      </div>
                                    </td>
                                  </tr>
                                </tbody>
