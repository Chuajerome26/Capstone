        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white shadow">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-2 mt-2">
                    <a href="../../Pages/newdesign.php/dashboard.php" class="list-group-item list-group-item-action py-2 border-0 ripple  <?php echo ($current_nav == 'dashboard') ? 'active' : ''; ?>">
                    ...
                    <a href="../../Pages/admin/index.php" class="list-group-item list-group-item-action py-2 mb-2 border-0  ripple  <?php echo ($current_nav == 'announcement') ? 'active-nav-item' : ''; ?>">
                    ...
                    <a href="../../Pages/admin/pending_request.php" class="list-group-item list-group-item-action py-2 mb-2 border-0  ripple  <?php echo ($current_nav == 'requestpending') ? 'active-nav-item' : ''; ?>">
                    ...
                    <a href="../../Pages/admin/prod_approval.php" class="list-group-item list-group-item-action py-2 mb-2 border-0  ripple  <?php echo ($current_nav == 'productapproval') ? 'active-nav-item' : ''; ?>">
                    ...
                    <a href="../../Pages/admin/admin_calendar.php" class="list-group-item list-group-item-action py-2 mb-2 border-0  ripple  <?php echo ($current_nav == 'eventcalendar') ? 'active-nav-item' : ''; ?>">
                    ...
                    <a href="../../Pages/admin/users_list.php" class="list-group-item list-group-item-action py-2 mb-2 border-0  ripple  <?php echo ($current_nav == 'userlist') ? 'active-nav-item' : ''; ?>">
                    ...
                    <a href="../../Pages/admin/history.php" class="list-group-item list-group-item-action py-2 mb-2 border-0  ripple  <?php echo ($current_nav == 'history') ? 'active-nav-item' : ''; ?>">
